...
public class gridAdapter extends BaseAdapter{
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if(names.get(position).toString().equals("IMPORT FILE"))
        {
            imageView.setImageResource(R.mipmap.ic_import);
        ...
        }else if(names.get(position).toString().equals("VIEW"))
        {
...
//                    activity.startActivity(launchinIntent);
        ...
        {
            imageView.setImageResource(R.mipmap.ic_addstudent);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, AddStudent.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
        ...
        }else if(names.get(position).toString().equals("ADD FACULTY"))
        {
            imageView.setImageResource(R.mipmap.ic_addfaculty);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity,AddFaculty.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
        ...
        else if(names.get(position).toString().equals("MODIFY STUDENT DETAIL"))
        {
            imageView.setImageResource(R.mipmap.ic_modifystudent);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
...
//                    activity.startActivity(launchinIntent);
        ...
        else if(names.get(position).toString().equals("MODIFY FACULTY DETAIL"))
        {
            imageView.setImageResource(R.mipmap.ic_modifystudent);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
...
//                    activity.startActivity(launchinIntent);
        ...
        else if(names.get(position).toString().equals("REMOVE  STUDENT"))
        {
            imageView.setImageResource(R.mipmap.ic_removestudent);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    Intent launchinIntent = new Intent(activity, cgpa_activity.class);
//                    activity.startActivity(launchinIntent);
        ...
        else if(names.get(position).toString().equals("REMOVE  FACULTY"))
        {
            imageView.setImageResource(R.mipmap.ic_removestudent);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
